...
descr = """fmri-handbook-2e-code: code to generate figures and examples from Poldrack et al. Handbook of fMRI Data Analysis"""
...
DOWNLOAD_URL='https://github.com/poldrack/fmri-handbook-2e-code'
VERSION='0.1.0'
